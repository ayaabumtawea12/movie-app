...
const Searchtv = () => {
  ...
  const getsearch = async () => {
      ...
      const { data } = await axios.get(
        `https://api.themoviedb.org/3/search/tv?api_key=dc1d2c8dc004e789f8c26e808c8c91c2&language=en-US&query=${searchtext}&page=${page}&include_adult=false`
      );
...
<h1 className='text-dark mt-5'>Search TV</h1>
...
<Link to={`/details/tv/${movie.id}`} className='btn '>More...</Link>
</div>
</div>
