...
const Tvseries = () => {
    ...
    const getmovie=async()=> {
      const {data}=await axios.get(`https://api.themoviedb.org/3/discover/tv?api_key=dc1d2c8dc004e789f8c26e808c8c91c2&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&with_watch_monetization_types=flatrate&page=${page}&with_genres=${takegenres}`)
     // console.log(data);
...
<h1 className='text-dark  mt-5 text-uppercase'>TVSeries</h1>
